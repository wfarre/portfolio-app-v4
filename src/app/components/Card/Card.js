...
const Card = (props) => {
  return (
    <figure className="w-full">
      <div className="group relative w-full aspect-[621/321] rounded-lg overflow-hidden after:absolute after:bg-teal-500 after:top-0 after:left-0 after:z-10 after:h-full after:w-full after:opacity-0 hover:after:opacity-70 after:transition-all after:duration-300 ">
        <Image
      ...
      <ul className="flex gap-2 pb-4 items-center">
